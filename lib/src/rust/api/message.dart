...
}) => RustLib.instance.api.crateApiMessageSendQuoteMessage(
  text: text,
  sourceId: sourceId,
...
Future<MsgStruct> sendMergerMessage({
  ...
  required String sourceId,
  required SessionType sessionType,
}) => RustLib.instance.api.crateApiMessageSendMergerMessage(
  title: title,
...
Future<MsgStruct> sendCardMessage({
  ...
  required String sourceId,
  required SessionType sessionType,
}) => RustLib.instance.api.crateApiMessageSendCardMessage(
  userId: userId,
  nickname: nickname,
  faceUrl: faceUrl,
  ex: ex,
...
Future<MsgStruct> sendLocationMessage({
  ...
  required String sourceId,
  required SessionType sessionType,
}) => RustLib.instance.api.crateApiMessageSendLocationMessage(
...
Future<MsgStruct> sendFaceMessage({
  ...
  required String sourceId,
  required SessionType sessionType,
}) => RustLib.instance.api.crateApiMessageSendFaceMessage(
  index: index,
  data: data,
  sourceId: sourceId,
  sessionType: sessionType,
...
}) => RustLib.instance.api.crateApiMessageSendAdvancedQuoteMessage(
  text: text,
  sourceId: sourceId,
  sessionType: sessionType,
  quoteText: quoteText,
...
Future<MsgStruct> sendAtTextMessageWithQuote({
  ...
  required String sourceId,
  required SessionType sessionType,
}) => RustLib.instance.api.crateApiMessageSendAtTextMessageWithQuote(
  text: text,
