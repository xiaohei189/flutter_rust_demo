...
class CustomElem {
  ...
  @override
  int get hashCode =>
      data.hashCode ^ description.hashCode ^ extension_.hashCode;
...
class MsgStruct {
  ...
  bool operator ==(Object other) =>
      ...
      other is MsgStruct &&
          ...
          isRead == other.isRead &&
          status == other.status &&
          isReact == other.isReact &&
          isExternalExtensions == other.isExternalExtensions &&
