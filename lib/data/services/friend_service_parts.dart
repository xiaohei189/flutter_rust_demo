...
/// FriendApplicationsMixin
mixin FriendApplicationsMixin on Object {
  // ==================== 好友申请 ====================
...
/// FriendListMixin
mixin FriendListMixin on Object {
  // ==================== 好友列表 ====================
  ...
  /// 获取好友 ID 列表
  Future<List<String>> getFriendIdList(fb.OpenImBridgeClient client) async {
    try {
  ...
  Future<List<SearchFriendItem>> searchFriends(
    ...
    try {
      ...
      appLog.i(
        '[FriendService] 搜索好友: keyword=$keyword, 结果=${results.length} 条',
      );
      return results;
    } catch (e) {
...
/// FriendBlacklistMixin
mixin FriendBlacklistMixin on Object {
  // ==================== 黑名单 ====================
  ...
  /// 获取黑名单列表
  Future<List<String>> getBlackList(fb.OpenImBridgeClient client) async {
    try {
