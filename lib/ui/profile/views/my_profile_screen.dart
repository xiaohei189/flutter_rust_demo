...
class _MyProfileScreenState extends ConsumerState<MyProfileScreen> {
  ...
  Future<void> _editField({
    ...
    final result = await context.push<String>(
      '/profile/edit-field',
      extra: {'title': title, 'hint': hint, 'initialValue': currentValue},
    );
                    ...
                    children: [
                      ...
                      CardLayout(
                        children: [
                          ...
                          ListRow(
                            label: '手机号',
                            value: state.profile?.telephone.isNotEmpty == true
                                ? state.profile!.telephone
                                : '未绑定',
...
class ProfileFieldEditScreen extends StatefulWidget {
  ...
  @override
  State<ProfileFieldEditScreen> createState() => _ProfileFieldEditScreenState();
}
