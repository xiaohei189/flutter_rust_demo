...
impl<'a, C: WsRpcClient> WsMessageRpc<'a, C> {
    ...
    pub fn with_send_context(
        ...
        Self {
            ...
            send_ctx: Some(WsMessageSendContext {
                user_id,
                platform_id,
            }),
        }
    ...
    pub async fn pull_msg_by_range(
        &self,
    ...
    pub async fn pull_msg_by_seq_list(
        &self,
    ...
    pub async fn send_picture_message(
        &self,
        recv_id: String,
        picture: crate::im::model::message::PictureElem,
        session_type: i32,
    ) -> Result<()> {
    ...
    pub async fn send_sound_message(
        &self,
        recv_id: String,
        sound: crate::im::model::message::SoundElem,
        session_type: i32,
    ) -> Result<()> {
    ...
    pub async fn send_video_message(
        &self,
        recv_id: String,
        video: crate::im::model::message::VideoElem,
        session_type: i32,
    ) -> Result<()> {
    ...
    pub async fn send_file_message(
        &self,
        recv_id: String,
        file: crate::im::model::message::FileElem,
        session_type: i32,
    ) -> Result<()> {
    ...
    pub async fn send_message(
        ...
        let send_ctx = self
            .send_ctx
            .as_ref()
            .ok_or_else(|| anyhow::anyhow!("发送上下文未初始化"))?;
        ...
        let msg_data = sdkws::MsgData {
            ...
            client_msg_id: message
                .client_msg_id
                .clone()
                .unwrap_or_else(|| generate_msg_id(&send_ctx.user_id)),
        ...
        let msg_type = if not_oss || is_online_only {
    ...
    async fn send_rich_message(
        ...
        let msg_type = if is_online_only {
            msg_type::WS_SEND_MSG_NOT_OSS
        } else {
            msg_type::WS_SEND_MSG
        };
        ...
        Resp: ProtobufMessage + Default,
    {
        ...
        let resp = self
            .client
            .send_request_and_wait(msg_type, req_data, None)
            .await?;
