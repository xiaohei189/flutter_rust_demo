//! 会话模块
//!
//! 实现 OpenIM SDK 的会话同步功能（会话同步器已迁移至 client::conversation_handle）
...
pub use crate::im::api::conversation::ConversationApi;
pub use crate::im::client::conversation_handle::ConversationSyncer;
