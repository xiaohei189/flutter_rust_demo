...
impl OpenIMBridgeClient {
    ...
    pub async fn add_friend(&self, user_id: String, req_msg: String) -> Result<()> {
        self.inner.add_friend(&user_id, Some(&req_msg)).await.map_err(|e| anyhow::anyhow!("{}", e))
    }

    #[flutter_rust_bridge::frb]
    pub async fn delete_friend(&self, user_id: String) -> Result<()> {
        self.inner.delete_friend(&user_id).await.map_err(|e| anyhow::anyhow!("{}", e))
    }
    ...
    pub async fn add_black(&self, user_id: String) -> Result<()> {
        self.inner.add_black(&user_id).await.map_err(|e| anyhow::anyhow!("{}", e))
    }

    #[flutter_rust_bridge::frb]
    pub async fn remove_black(&self, user_id: String) -> Result<()> {
        self.inner.remove_black(&user_id).await.map_err(|e| anyhow::anyhow!("{}", e))
    }
    ...
    #[flutter_rust_bridge::frb]
    pub async fn check_friend(&self, user_ids: Vec<String>) -> Result<Vec<crate::infra::http::friend::CheckFriendResult>> {
        self.inner.check_friend(user_ids).await.map_err(|e| anyhow::anyhow!("{}", e))
    }

    #[flutter_rust_bridge::frb]
    pub async fn get_friend_apply_list(&self) -> Result<Vec<FriendApplyInfo>> {
        self.inner.get_friend_apply_list().await.map_err(|e| anyhow::anyhow!("{}", e))
    }

    #[flutter_rust_bridge::frb]
    pub async fn get_friend_apply_list_as_applicant(&self) -> Result<Vec<FriendApplyInfo>> {
        self.inner.get_friend_apply_list_as_applicant().await.map_err(|e| anyhow::anyhow!("{}", e))
    }

    #[flutter_rust_bridge::frb]
    pub async fn get_friend_application_unhandled_count(&self) -> Result<i32> {
        self.inner.get_friend_application_unhandled_count().await.map_err(|e| anyhow::anyhow!("{}", e))
    }

    #[flutter_rust_bridge::frb]
    pub async fn accept_friend_application(&self, user_id: String, handle_msg: Option<String>) -> Result<()> {
        self.inner.accept_friend_application(&user_id, handle_msg.as_deref()).await.map_err(|e| anyhow::anyhow!("{}", e))
    }

    #[flutter_rust_bridge::frb]
    pub async fn refuse_friend_application(&self, user_id: String, handle_msg: Option<String>) -> Result<()> {
        self.inner.refuse_friend_application(&user_id, handle_msg.as_deref()).await.map_err(|e| anyhow::anyhow!("{}", e))
    }
    ...
    pub async fn sync_friends_incremental(&self) -> Result<()> {
        self.inner.sync_friends_incremental().await.map_err(|e| anyhow::anyhow!("{}", e))
    }
    ...
    #[flutter_rust_bridge::frb]
    pub async fn search_friends(&self, keyword: String) -> Result<Vec<crate::infra::http::friend::SearchFriendItem>> {
        self.inner.search_friends(&keyword).await.map_err(|e| anyhow::anyhow!("{}", e))
    }
    ...
    pub async fn update_friends(&self, friend_user_ids: Vec<String>, is_pinned: Option<bool>, remark: Option<String>, ex: Option<String>) -> Result<()> {
        self.inner.update_friends(friend_user_ids, is_pinned, remark, ex).await.map_err(|e| anyhow::anyhow!("{}", e))
    }
}
