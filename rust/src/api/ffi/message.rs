...
impl OpenIMBridgeClient {
    ...
    pub async fn send_text_message(&self, text: String, source_id: String, session_type: SessionType) -> Result<MsgStruct> {
        self.inner
            .send_text_message(&text, &source_id, session_type.into())
            .await
            .map(|msg| msg.into())
    ...
    pub async fn send_markdown_message(&self, text: String, source_id: String, session_type: SessionType) -> Result<MsgStruct> {
        self.inner
            .send_markdown_message(&text, &source_id, session_type.into())
            .await
            .map(|msg| msg.into())
            .map_err(|e| anyhow::anyhow!("{}", e))
    }
    ...
    #[flutter_rust_bridge::frb]
    pub async fn get_history_messages(&self, req: GetHistoryMessagesReq) -> Result<crate::sdk::client::GetHistoryMessagesResult> {
        self.inner.get_history_messages(req).await.map_err(|e| anyhow::anyhow!("{}", e))
    }

    #[flutter_rust_bridge::frb]
    pub async fn revoke_message(&self, req: RevokeMessageReq) -> Result<()> {
        self.inner.revoke_message(req).await.map_err(|e| anyhow::anyhow!("{}", e))
    }

    #[flutter_rust_bridge::frb]
    pub async fn delete_messages(&self, req: DeleteMessagesReq) -> Result<()> {
        self.inner.delete_messages(req).await.map_err(|e| anyhow::anyhow!("{}", e))
    }

    #[flutter_rust_bridge::frb]
    pub async fn mark_messages_as_read(&self, req: MarkMessagesAsReadReq) -> Result<()> {
        self.inner.mark_messages_as_read(req).await.map_err(|e| anyhow::anyhow!("{}", e))
    }

    #[flutter_rust_bridge::frb]
    pub async fn mark_conversation_message_as_read(&self, conversation_id: String, session_type: SessionType) -> Result<()> {
        self.inner
            .mark_conversation_message_as_read(conversation_id, session_type.into())
            .await
            .map_err(|e| anyhow::anyhow!("{}", e))
    }
    ...
    #[flutter_rust_bridge::frb]
    pub async fn send_at_text_message(&self, text: String, at_user_ids: Vec<String>, source_id: String, session_type: SessionType) -> Result<MsgStruct> {
        self.inner
            .send_at_text_message(&text, at_user_ids, &source_id, session_type.into())
            .await
            .map(|msg| msg.into())
            .map_err(|e| anyhow::anyhow!("{}", e))
    }
    ...
    #[flutter_rust_bridge::frb]
    pub async fn send_custom_message(&self, data: String, desc: String, extension: String, source_id: String, session_type: SessionType) -> Result<MsgStruct> {
        self.inner
            .send_custom_message(&data, &desc, &extension, &source_id, session_type.into())
            .await
            .map(|msg| msg.into())
            .map_err(|e| anyhow::anyhow!("{}", e))
    }
...
#[flutter_rust_bridge::frb]
pub async fn send_card_message(user_id: String, nickname: String, face_url: String, ex: String, source_id: String, session_type: SessionType) -> Result<MsgStruct> {
    let client = client_holder()?;
...
#[flutter_rust_bridge::frb]
pub async fn send_location_message(description: String, longitude: f64, latitude: f64, source_id: String, session_type: SessionType) -> Result<MsgStruct> {
    let client = client_holder()?;
...
#[flutter_rust_bridge::frb]
pub async fn send_face_message(index: i32, data: String, source_id: String, session_type: SessionType) -> Result<MsgStruct> {
    let client = client_holder()?;
...
pub async fn send_advanced_quote_message(
    ...
    let result = client.send_advanced_quote_message(&text, quote_struct, message_entities, &source_id, session_type.into()).await?;
    Ok(result.into())
}
...
pub async fn send_at_text_message_with_quote(
    ...
    let client = client_holder()?;
    let result = client
        .send_at_text_message_with_quote(&text, at_user_list, at_users_info, None, &source_id, session_type.into())
        .await?;
    Ok(result.into())
}
