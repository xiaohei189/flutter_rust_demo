...
impl OpenIMBridgeClient {
    ...
    #[flutter_rust_bridge::frb]
    pub async fn create_group(&self, group_name: String, group_type: i32, member_ids: Vec<String>) -> Result<crate::domain::model::group::GroupInfo> {
        self.inner
            .create_group(&group_name, crate::domain::constant::GroupType::from_i32(group_type), &member_ids)
            .await
