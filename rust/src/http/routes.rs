...
pub const GET_SELF_FRIEND_APPLY_LIST: &str = "/friend/get_self_friend_apply_list";
pub const GET_SELF_UNHANDLED_APPLY_COUNT: &str = "/friend/get_self_unhandled_apply_count";
pub const ACCEPT_FRIEND_APPLICATION: &str = "/friend/add_friend_response";
pub const REFUSE_FRIEND_APPLICATION: &str = "/friend/add_friend_response";
pub const RESPOND_FRIEND_APPLY: &str = "/friend/add_friend_response";
...
pub const SET_GROUP_INFO: &str = "/group/set_group_info_ex";
...
pub const KICK_GROUP_MEMBER: &str = "/group/kick_group";
pub const TRANSFER_GROUP_OWNER: &str = "/group/transfer_group";
...
pub const GET_GROUP_APPLICATION_LIST: &str = "/group/get_recv_group_applicationList";
pub const GET_RECV_GROUP_APPLICATION_LIST: &str = "/group/get_recv_group_applicationList";
pub const GET_SEND_GROUP_APPLICATION_LIST: &str = "/group/get_user_req_group_applicationList";
pub const GET_GROUP_APPLICATION_UNHANDLED_COUNT: &str = "/group/get_group_application_unhandled_count";
pub const ACCEPT_GROUP_APPLICATION: &str = "/group/group_application_response";
pub const REFUSE_GROUP_APPLICATION: &str = "/group/group_application_response";
pub const GROUP_APPLICATION_RESPONSE: &str = "/group/group_application_response";
...
pub const SET_CONVERSATION: &str = "/conversation/set_conversations";
...
pub const MARK_CONVERSATION_AS_READ: &str = "/msg/mark_conversation_as_read";
