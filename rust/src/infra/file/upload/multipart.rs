...
impl FileUploader {
    pub(crate) async fn upload_file_multipart(&self, file_path: &str, name: &str, content_type: &str, file_size: i64, cb: Option<&dyn UploadFileCallback>) -> Result<UploadResult> {
    ...
    pub(crate) async fn get_part_info(&self, file_path: &str, file_size: i64, cb: &dyn UploadFileCallback) -> Result<PartInfo> {
    ...
    pub(crate) async fn part_size(&self, size: i64) -> Result<i64> {
    ...
    pub(crate) async fn get_part_limit(&self) -> Result<PartLimitResp> {
        {
    ...
    pub(crate) fn clean_part_limit(&self) {
