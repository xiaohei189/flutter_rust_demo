...
impl MessageDao {
    ...
    pub async fn batch_insert(&self, logs: &[LocalChatLog]) -> Result<()> {
        info!("[DB] batch_insert: count={}", logs.len());
        for log in logs {
            sqlx::query(
    ...
    pub async fn get_by_conversation(
        ...
        info!("[DB] get_by_conversation: conversation_id={}, start_time={}, count={}", conversation_id, start_time, count);
    ...
    pub async fn get_max_seq(&self, conversation_id: &str) -> Result<i64> {
        info!("[DB] get_max_seq: conversation_id={}", conversation_id);
    ...
    pub async fn get_by_client_msg_id(
        ...
        info!("[DB] get_by_client_msg_id: conversation_id={}, client_msg_id={}", conversation_id, client_msg_id);
    ...
    pub async fn get_by_conversation_and_seq(&self, conversation_id: &str, seq: i64) -> Result<Option<LocalChatLog>> {
        info!("[DB] get_by_conversation_and_seq: conversation_id={}, seq={}", conversation_id, seq);
        let row = sqlx::query_as::<_, LocalChatLog>(
    ...
    pub async fn get_by_client_msg_ids(&self, client_msg_ids: &[String]) -> Result<Vec<LocalChatLog>> {
        ...
        info!("[DB] get_by_client_msg_ids: count={}", client_msg_ids.len());
    ...
    pub async fn get_latest(
        ...
        info!("[DB] get_latest: conversation_id={}, limit={}", conversation_id, limit);
        let rows = sqlx::query_as::<_, LocalChatLog>(
    ...
    pub async fn delete_by_conversation(&self, conversation_id: &str) -> Result<()> {
        info!("[DB] delete_by_conversation: conversation_id={}", conversation_id);
    ...
    pub async fn update_send_status(&self, client_msg_id: &str, status: MessageSendStatus) -> Result<()> {
        info!("[DB] update_send_status: client_msg_id={}, status={:?}", client_msg_id, status);
    ...
    pub async fn update_after_send_success(&self, client_msg_id: &str, server_msg_id: &str, send_time: i64) -> Result<()> {
        info!("[DB] update_after_send_success: client_msg_id={}, server_msg_id={}", client_msg_id, server_msg_id);
        sqlx::query(
    ...
    pub async fn batch_update_seq(&self, updates: &[(String, i64)]) -> Result<()> {
        info!("[DB] batch_update_seq: count={}", updates.len());
    ...
    pub async fn mark_as_read_by_max_seq(&self, conversation_id: &str, max_seq: i64, self_user_id: &str) -> Result<()> {
        info!("[DB] mark_as_read_by_max_seq: conversation_id={}, max_seq={}, self_user_id={}", conversation_id, max_seq, self_user_id);
        sqlx::query(
    ...
    pub async fn delete_by_client_msg_id(&self, conversation_id: &str, client_msg_id: &str) -> Result<()> {
        info!("[DB] delete_by_client_msg_id: conversation_id={}, client_msg_id={}", conversation_id, client_msg_id);
    ...
    pub async fn update_content_type(&self, conversation_id: &str, client_msg_id: &str, content_type: i32) -> Result<()> {
        info!("[DB] update_content_type: conversation_id={}, client_msg_id={}, content_type={}", conversation_id, client_msg_id, content_type);
    ...
    pub async fn update_message_content_and_type(
        ...
        info!("[DB] update_message_content_and_type: conversation_id={}, client_msg_id={}, content_type={}", conversation_id, client_msg_id, content_type);
    ...
    pub async fn search_by_keyword(&self, conversation_id: &str, keyword: &str, max_count: i64) -> Result<Vec<LocalChatLog>> {
        info!("[DB] search_by_keyword: conversation_id={}, keyword={}, max_count={}", conversation_id, keyword, max_count);
    ...
    pub async fn search_by_content_type(&self, conversation_id: &str, content_type: i32) -> Result<Vec<LocalChatLog>> {
        info!("[DB] search_by_content_type: conversation_id={}, content_type={}", conversation_id, content_type);
        let rows = sqlx::query_as::<_, LocalChatLog>(
    ...
    pub async fn mark_as_read_by_seqs(&self, conversation_id: &str, seqs: &[i64], self_user_id: &str) -> Result<()> {
        ...
        info!("[DB] mark_as_read_by_seqs: conversation_id={}, seq_count={}", conversation_id, seqs.len());
    ...
    pub async fn mark_as_read_by_seqs_all(&self, conversation_id: &str, seqs: &[i64]) -> Result<()> {
        ...
        info!("[DB] mark_as_read_by_seqs_all: conversation_id={}, seq_count={}", conversation_id, seqs.len());
        let placeholders = seqs.iter().map(|_| "?").collect::<Vec<_>>().join(",");
        let sql = format!(
    ...
    pub async fn get_unread_messages(&self, conversation_id: &str, self_user_id: &str) -> Result<Vec<LocalChatLog>> {
        info!("[DB] get_unread_messages: conversation_id={}, self_user_id={}", conversation_id, self_user_id);
        let rows = sqlx::query_as::<_, LocalChatLog>(
    ...
    pub async fn mark_as_read_by_client_msg_ids(
        ...
        info!("[DB] mark_as_read_by_client_msg_ids: conversation_id={}, id_count={}", conversation_id, client_msg_ids.len());
        let placeholders = client_msg_ids.iter().map(|_| "?").collect::<Vec<_>>().join(",");
        let sql = format!(
    ...
    pub async fn get_peer_normal_msg_seq(&self, conversation_id: &str, self_user_id: &str) -> Result<i64> {
        info!("[DB] get_peer_normal_msg_seq: conversation_id={}, self_user_id={}", conversation_id, self_user_id);
        let row: (Option<i64>,) = sqlx::query_as(
    ...
    pub async fn get_by_seqs(&self, conversation_id: &str, seqs: &[i64]) -> Result<Vec<LocalChatLog>> {
        ...
        info!("[DB] get_by_seqs: conversation_id={}, seq_count={}", conversation_id, seqs.len());
        let placeholders = seqs.iter().map(|_| "?").collect::<Vec<_>>().join(",");
        let sql = format!(
    ...
    pub async fn get_by_conversation_asc(
        ...
        info!("[DB] get_by_conversation_asc: conversation_id={}, start_time={}, count={}", conversation_id, start_time, count);
        let rows = sqlx::query_as::<_, LocalChatLog>(
    ...
    pub async fn update_local_ex(&self, conversation_id: &str, client_msg_id: &str, local_ex: &str) -> Result<()> {
        info!("[DB] update_local_ex: conversation_id={}, client_msg_id={}", conversation_id, client_msg_id);
    ...
    pub async fn mark_as_deleted(&self, conversation_id: &str, client_msg_id: &str) -> Result<()> {
        info!("[DB] mark_as_deleted: conversation_id={}, client_msg_id={}", conversation_id, client_msg_id);
    ...
    pub async fn get_min_seq(&self, conversation_id: &str) -> Result<i64> {
        info!("[DB] get_min_seq: conversation_id={}", conversation_id);
        let row: (Option<i64>,) = sqlx::query_as(
    ...
    pub async fn get_existing_seqs_in_range(
        ...
        info!("[DB] get_existing_seqs_in_range: conversation_id={}, min_seq={}, max_seq={}", conversation_id, min_seq, max_seq);
    ...
    pub async fn get_by_seq_range(
        ...
        info!("[DB] get_by_seq_range: conversation_id={}, start_seq={}, end_seq={}, count={}", conversation_id, start_seq, end_seq, count);
        let rows = sqlx::query_as::<_, LocalChatLog>(
