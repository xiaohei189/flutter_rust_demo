...
impl GroupApi for OpenIMClient {
    ...
    #[tracing::instrument(skip_all, fields(group_id = %group_id))]
    async fn set_group_info(
        &self,
        group_id: &str,
        group_name: Option<&str>,
        face_url: Option<&str>,
    ) -> Result<()> {
        self.group.set_group_info(crate::model::group::SetGroupInfoFields {
    ...
    async fn set_group_member_info(
        ...
        self.group.set_group_member_info(crate::http::group::SetGroupMemberFields {
            group_id: group_id.to_string(),
