...
mod tests {
    ...
    fn make_service(pool: sqlx::SqlitePool) -> super::MessageService {
        ...
        super::MessageService {
            ...
            checker: None,
            seq_pull_context: Arc::new(tokio::sync::Mutex::new(crate::core::message::receive::checker::SeqPullContext::default())),
        }
    }
    ...
    async fn test_get_history_messages_fills_seq_gap_from_server() {
        ...
        let checker = Arc::new(crate::core::message::receive::checker::MessageChecker::new(
    ...
    fn make_service_with_hub(
        ...
        super::MessageService,
        tokio::sync::mpsc::UnboundedReceiver<crate::core::event::events::conversation::ConversationEvent>,
        tokio::sync::mpsc::UnboundedReceiver<crate::core::event::events::message::MessageEvent>,
    ) {
        let repos = make_repositories(pool);
    ...
    async fn test_clear_conversation_and_delete_all_msg() {
        ...
        // Changed 事件（空列表）
        assert!(matches!(conv_rx.try_recv().unwrap(), crate::core::event::events::conversation::ConversationEvent::Changed(_)));
    }
    ...
    async fn test_delete_conversation_and_delete_all_msg() {
        ...
        match conv_rx.try_recv().unwrap() {
            crate::core::event::events::conversation::ConversationEvent::Deleted(ids) => assert_eq!(ids, vec!["conv_1"]),
    ...
    async fn test_delete_all_msg_from_local_and_svr() {
        ...
        match conv_rx.try_recv().unwrap() {
            crate::core::event::events::conversation::ConversationEvent::TotalUnreadCountChanged(0) => {}
