...
use crate::core::event::events::message::{MessageEvent, MessageListenerExt, MessageReceipt};
...
mod tests {
    ...
    async fn test_read_receipt_self_sync_idempotent_skips_second_event() {
        ...
        let handler = MessageProcessor::new(repositories, UserId::new("user_1"), hub.clone(), crate::core::event::test_util::noop_message_listener());
