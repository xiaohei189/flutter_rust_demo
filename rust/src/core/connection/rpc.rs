...
use crate::core::connection::ws::{OpenIMReq, OpenIMResp};
...
impl ConnectionManager {
        ...
        R: prost::Message + Default + std::fmt::Debug,
    {
        ...
        self.pending_requests.write().await.insert(msg_incr.clone(), crate::core::connection::manager::PendingRequest { tx });
